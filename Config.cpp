...
void Config::load(size_t id) noexcept
{
...

    {
		...
		if (visualsJson.isMember("Aspect Ratio")) visuals.aspectRatio = visualsJson["Aspect Ratio"].asBool();
		if (visualsJson.isMember("aspect ratio value")) visuals.aspectRatio_value = visualsJson["Aspect Ratio Value"].asInt();
    }
