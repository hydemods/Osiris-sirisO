...
void GUI::renderVisualsWindow() noexcept
{
    if (window.visuals) {
        ...
        ImGui::Combo("Screen effect", &config.visuals.screenEffect, "None\0Drone cam\0Underwater\0");
		ImGui::SetCursorPosX(ImGui::GetCursorPosX() + 10);
		if (!config.visuals.aspectRatio)
		{
			ImGui::SetCursorPosX(ImGui::GetCursorPosX() + 10);
			ImGui::SliderInt("aspect ratio value", &config.visuals.aspectRatio_value, 0, 200);
			ImGui::SetCursorPosX(ImGui::GetCursorPosX() + 10);
		}
